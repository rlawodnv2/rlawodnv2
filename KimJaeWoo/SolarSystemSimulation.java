...
public class SolarSystemSimulation extends JPanel {
    ...
    public SolarSystemSimulation() {
        ...
        bodies[0] = new CelestialBody(1000, 0, 0, 0, 30, Color.YELLOW, "Sun");
        bodies[1] = new CelestialBody(0.055, 70, 0, 2.7, 5, Color.GRAY, "Mercury");
        bodies[2] = new CelestialBody(0.815, 110, 0, 2.1, 8, Color.ORANGE, "Venus");
        bodies[3] = new CelestialBody(1, 150, 0, 2, 10, Color.BLUE, "Earth");
        bodies[4] = new CelestialBody(0.107, 190, 0, 1.6, 7, Color.RED, "Mars");
        bodies[5] = new CelestialBody(317.8, 260, 0, -1, 25, Color.LIGHT_GRAY, "Jupiter");
        bodies[6] = new CelestialBody(95.2, 320, 0, -0.7, 20, Color.YELLOW, "Saturn");
        bodies[7] = new CelestialBody(14.5, 370, 0, -0.5, 15, Color.CYAN, "Uranus");
        bodies[8] = new CelestialBody(17.1, 420, 0, -0.4, 15, Color.BLUE, "Neptune");
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (CelestialBody body : bodies) {
            ...
            g.drawString(body.name, x + radius + 5, y - radius - 5);
        }
    }
